...
export default async function ShopDetail({ params }: ProductDetailPageProps) {
  const { id } = await params;

  const product = await getData<ProductType>(`${ENDPOINTS.PRODUCTS}/${id}`);
